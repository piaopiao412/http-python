...
class S(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        logging.info("POST request,\nPath: %s\nHeaders:\n%s\n\nBody:\n%s\n",
                str(self.path), str(self.headers), post_data.decode('ISO-8859-1'))

        res = "You Input: " + post_data.decode('ISO-8859-1')

        self.do_HEAD()
        # self.wfile.write("POST request for {}".format(self.path).encode('utf-8'))
        self.wfile.write("{}".format(res).encode('ISO-8859-1'))
    ...
    def handle_http(self, status_code, path):
        ...
        content = '''
           ...
           '''.format(path)
        return bytes(content, 'ISO-8859-1')
